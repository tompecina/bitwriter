...
public class Variable {
	...
	log.finer("Setting variable '" + name +
		  "' to: " + Util.bigIntegerToString(value));
	this.value = value;
    }
	...
	log.finer("Setting onAggregateStreamIn on '" + name +
		  "' to: " + onAggregateStreamIn);
	...
	log.finest("Getting onOutputStream on '" + name +
		   "': " + onOutputStream);
